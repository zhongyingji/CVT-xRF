...
def run_training(train_module: str, train_name: str, seed: int, cudnn_benchmark: bool=True, data_root: str='',
    ...
    train_module_for_launching = train_module # nerf_training_w_gt_poses/dtu
    ...
    train_module = '/'.join(base_dir_train_module) # nerf_training_w_gt_poses/dtu/subset_3/scan82

    
    settings.module_name_for_eval = train_module_for_launching
    settings.module_name = train_module
    settings.script_name = train_name # sparf
...
def main():
    ...
    parser.add_argument('--render_point_cloud_vis', type=bool, default=False, 
                        help='save the point cloud of render poses')
